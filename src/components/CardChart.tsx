...
import { getCardBreakdown } from '@/store/invoiceStore';
...
export function CardChart({ referenceMonth }: CardChartProps) {
  const data = getCardBreakdown(referenceMonth);
    ...
    return (
      <div className="glass-card p-6">
        ...
        <div className="flex items-center justify-center h-48 text-muted-foreground text-sm">
          Nenhuma fatura com cartão neste mês
        </div>
      </div>
    );
  }
